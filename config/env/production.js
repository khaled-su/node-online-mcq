...
module.exports = {
	db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/mcq-app',
	assets: {
		lib: {
			css: [
				...
				'client/lib/toastr/toastr.min.css'
			],
			js: [
				...
				'client/lib/angular-spinner/angular-spinner.min.js',
				...
				'client/lib/toastr/toastr.min.js'
			]
		},
